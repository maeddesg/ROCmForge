...
// ── GFX12 (RDNA4) optimized GEMV using v_dot4_u32_u8 ────────────────────────────

pub fn gemv_q4_0_f32_q8_inline_residual_gfx12_on_stream(
    weights_q4_0: *const u8,
    input: *const f32,
    residual: *const f32,
    output: *mut f32,
    ...
    if n_rows == 0 || ncols_dst == 0 {
        return Err(GpuError::HipApiError {
            code: -1,
            description:
                "gemv_q4_0_f32_q8_inline_residual_gfx12: n_rows and ncols_dst cannot be zero"
                    .to_string(),
        });
    }
    if n_rows % QK4_0 != 0 {
        return Err(GpuError::HipApiError {
            code: -1,
            description: format!(
                "gemv_q4_0_f32_q8_inline_residual_gfx12: n_rows must be multiple of {}, got {}",
                QK4_0, n_rows
            ),
        });
    }
    if weights_q4_0.is_null() || input.is_null() || residual.is_null() || output.is_null() {
        return Err(GpuError::HipApiError {
            code: -1,
            description:
                "gemv_q4_0_f32_q8_inline_residual_gfx12: kernel pointers must be non-null"
                    .to_string(),
        });
    }

    let result = unsafe {
        gemv_q4_0_f32_q8_inline_residual_gfx12_launch(
    ...
    if result != hipError_t::hipSuccess {
        return Err(GpuError::HipApiError {
            code: result as i32,
            description: format!(
                "gemv_q4_0_f32_q8_inline_residual_gfx12 kernel failed: {:?}",
                result
            ),
        });
    }
...
pub fn gemv_q4_0_f32_q8_inline_gfx12_on_stream(
    weights_q4_0: *const u8,
    input: *const f32,
    output: *mut f32,
    n_rows: usize,
    ...
    if n_rows == 0 || ncols_dst == 0 {
        return Err(GpuError::HipApiError {
            code: -1,
            description: "gemv_q4_0_f32_q8_inline_gfx12: n_rows and ncols_dst cannot be zero"
                .to_string(),
        });
    }
    if n_rows % QK4_0 != 0 {
        return Err(GpuError::HipApiError {
            code: -1,
            description: format!(
                "gemv_q4_0_f32_q8_inline_gfx12: n_rows must be multiple of {}, got {}",
                QK4_0, n_rows
            ),
        });
    }
    if weights_q4_0.is_null() || input.is_null() || output.is_null() {
        return Err(GpuError::HipApiError {
            code: -1,
            description: "gemv_q4_0_f32_q8_inline_gfx12: kernel pointers must be non-null"
                .to_string(),
        });
    }

    let result = unsafe {
        gemv_q4_0_f32_q8_inline_gfx12_launch(
            weights_q4_0 as *const std::ffi::c_void,
            input,
            output,
            n_rows as c_int,
    ...
    if result != hipError_t::hipSuccess {
        return Err(GpuError::HipApiError {
            code: result as i32,
            description: format!(
                "gemv_q4_0_f32_q8_inline_gfx12 kernel failed: {:?}",
                result
            ),
        });
    }
...
unsafe extern "C" {
    ...
    fn gemv_q4_0_f32_q8_inline_residual_gfx12_launch(
        weights_q4_0: *const c_void,
        input: *const f32,
        residual: *const f32,
        output: *mut f32,
    ...
    fn gemv_q4_0_f32_q8_inline_gfx12_launch(
        weights_q4_0: *const c_void,
        input: *const f32,
        output: *mut f32,
        n_rows: c_int,
